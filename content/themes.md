...
params:
    description: "Our 143 themes give style to your Aliucord client."
---
...
<div class="md-text-field md-search-field">
    ...
    <label for=plugin-search>Search themes...</label>
</div>
...
<script>
    fetch("https://rautobot.github.io/themes-repo/data.json").then(r => r.json()).then(json => {
        ...
        for(i=0;i<json.length;i++) {
            ...
            author.insertAdjacentText("beforeend", json[i].author);
